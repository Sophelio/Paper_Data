...
**Polished 2026-09-16** (see `../README.md`). Only `_final.py` was edited; the non-final script is untouched lineage. Running the regenerate command writes to `Figures/figs/` inside this folder; copy the three outputs up one level.
