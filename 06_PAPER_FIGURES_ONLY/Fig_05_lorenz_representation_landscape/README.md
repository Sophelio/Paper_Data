...
| final asset | `figure5_lorenz_representation_landscape_final_tnr_v5_nature.pdf` |
...
| regenerate | `python figure_source/figure5_lorenz_representation_landscape_final_tnr_v5_nature.py` |
